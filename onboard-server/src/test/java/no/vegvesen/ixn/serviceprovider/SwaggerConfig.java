...
public class SwaggerConfig {
    ...
    public OpenApiCustomizer openApiCustomizer(){
            return openApi -> {
                ...
                openApi.getComponents().addSchemas("GetCapabilityResponse", ModelConverters.getInstance().readAllAsResolvedSchema(FetchMatchingCapabilitiesResponse.class).schema);
