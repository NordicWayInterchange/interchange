...
As the installation and configuration can be a bit involved, and that the actual config will change depending on the cloud provider/installation of Kubernetes,
