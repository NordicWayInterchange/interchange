...
public class CapabilityProperty {
    ...
    public static final CapabilityProperty STATION_TYPE = new CapabilityProperty("stationType");

    public static final List<CapabilityProperty> camCapabilityProperties = Collections.singletonList(
            STATION_TYPE
    );
