...
public class DeliveryEndpointImportApi {
    ...
    public DeliveryEndpointImportApi() {

    }

    public DeliveryEndpointImportApi(String host,
                                     Integer port,
                                     String target,
    ...
    public boolean equals(Object o) {
        ...
        DeliveryEndpointImportApi that = (DeliveryEndpointImportApi) o;
    ...
    public String toString() {
        return "DeliveryEndpointImportApi{" +
                "host='" + host + '\'' +
                ", port=" + port +
                ", target='" + target + '\'' +
