...
public class SsemCapabilityApi extends CapabilityApi{
    ...
    public SsemCapabilityApi(String publisherId, String originatingCountry, String protocolVersion, Set<String> quadTree, RedirectStatusApi redirect, Set<String> ids) {
