...
public class CapabilityTransformerTest {
	...
	@Test
	public void interchageIsConvertedToCapabilityApiAndBack(){

		Interchange interchange = new Interchange();
		interchange.setName("Test 1");
		DataType dataType = new DataType("datex2;1.0", "NO", "Conditions");
		Capabilities capabilities = new Capabilities(Capabilities.CapabilitiesStatus.KNOWN, Collections.singleton(dataType));
		...
		assertTrue(interchange.equals(transformed));
	}
	...
	public void capabilitiyApiIsConvertedToInterchangeAndBack(){
		...
		assertTrue(capabilityApi.equals(transformed));
