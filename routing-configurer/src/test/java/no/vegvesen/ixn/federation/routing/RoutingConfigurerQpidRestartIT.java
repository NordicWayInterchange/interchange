...
public class RoutingConfigurerQpidRestartIT extends QpidDockerBaseIT {
    ...
    @Container
    public static final KeysContainer keyContainer = getKeyContainer(RoutingConfigurerQpidRestartIT.class,"my_ca", "localhost", "routing_configurer", "king_gustaf", "nordea");
