...
@SpringBootTest(classes = {ServiceProviderRouter.class, QpidClient.class, QpidClientConfig.class, InterchangeNodeProperties.class, RoutingConfigurerProperties.class, LocalDeliveryService.class, TestSSLContextConfigGeneratedExternalKeys.class, TestSSLProperties.class})
