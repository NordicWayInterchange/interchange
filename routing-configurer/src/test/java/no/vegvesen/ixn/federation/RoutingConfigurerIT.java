...
public class RoutingConfigurerIT extends QpidDockerBaseIT {
	...
	public void neighbourIsBothCreatedAndUpdated() {
		...
		ServiceProvider sp = new ServiceProvider("sp");
		sp.setCapabilities(new Capabilities(Capabilities.CapabilitiesStatus.KNOWN, new HashSet<>(Collections.singletonList(cap1))));
	...
	public void routingIsNotSetUpWhenRedirectIsNotAvailable() {
		Capability cap = new DatexCapability("NO-1234", "NO", "1.0", new HashSet<>(Arrays.asList("01230122", "01230123")), RedirectStatus.NOT_AVAILABLE, new HashSet<>(Collections.singletonList("Road Block")));
