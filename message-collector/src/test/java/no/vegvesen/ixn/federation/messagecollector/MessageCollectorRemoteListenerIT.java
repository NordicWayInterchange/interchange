...
public class MessageCollectorRemoteListenerIT extends DockerBaseIT {
    ...
    @Test
    public void stoppingRemoteContainerStopsListener() throws NamingException, JMSException {
