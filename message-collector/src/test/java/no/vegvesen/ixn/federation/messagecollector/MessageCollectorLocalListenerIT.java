...
public class MessageCollectorLocalListenerIT extends QpidDockerBaseIT {
	...
	@Container
	public GenericContainer localContainer = getQpidContainer("docker/consumer", 			"jks",
			"localhost.p12",
			"password",
			"truststore.jks",
			"password");
	...
	@SuppressWarnings("rawtypes")
	@Container
	public GenericContainer remoteContainer = getQpidContainer("docker/producer", 			"jks",
			"localhost.p12",
			"password",
			"truststore.jks",
			"password");
