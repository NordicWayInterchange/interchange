...
public class CapabilitiesTransformerTest {
    ...
    public void addMetadataWithoutShardCount() {
        ...
        capabilities.add(new CapabilitySplitApi(new DatexApplicationApi("myPublisherId", "pub-1", "NO", "pv1", Collections.singleton("23004"), "myPublicationType"), new MetadataApi()));
    ...
    public void addMetadataWithShardCount() {
        ...
        capabilities.add(new CapabilitySplitApi(new DatexApplicationApi("myPublisherId", "pub-1", "NO", "pv1", Collections.singleton("23004"), "myPublicationType"), metadataApi));
        CapabilitiesSplitApi capabilitiesApi = new CapabilitiesSplitApi("norway", capabilities);
