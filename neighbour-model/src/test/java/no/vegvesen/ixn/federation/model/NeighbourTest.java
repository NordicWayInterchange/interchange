...
public class NeighbourTest {
	...
	public void shouldCheckSubscriptionRequestsForUpdates_neighbourWithNewCapabilityPostShouldCheckSubscriptionRequest() {
		...
		NeighbourCapabilities capabilities = new NeighbourCapabilities(NeighbourCapabilities.NeighbourCapabilitiesStatus.KNOWN, new HashSet<>());
		capabilities.setLastCapabilityExchange(capabilityExchangeTimeNow);
	...
	private Neighbour neighbourSeenYesterday() {
		...
		seenYesterday.setCapabilities(new NeighbourCapabilities(NeighbourCapabilities.NeighbourCapabilitiesStatus.KNOWN, Sets.newHashSet()));
