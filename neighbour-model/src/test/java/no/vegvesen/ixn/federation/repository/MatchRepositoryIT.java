...
public class MatchRepositoryIT {
    ...
    public void saveNeighbourAndServiceProviderBeforeSavingMatch() {
        ...
        Neighbour neighbour = new Neighbour("neighbour", new NeighbourCapabilities(), new NeighbourSubscriptionRequest(), new SubscriptionRequest(SubscriptionRequestStatus.REQUESTED, Collections.singleton(sub)));
    ...
    public void tryAddingTwoMatchesWithSameLocalSubscription() {
        ...
        Neighbour neighbour1 = new Neighbour("neighbour1", new NeighbourCapabilities(), new NeighbourSubscriptionRequest(), new SubscriptionRequest(SubscriptionRequestStatus.REQUESTED, Collections.singleton(sub1)));
