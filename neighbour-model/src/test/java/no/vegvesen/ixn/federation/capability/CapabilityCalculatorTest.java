...
public class CapabilityCalculatorTest {
    ...
    void calculateSelfCapabilitiesTest() {
        ...
        Capabilities firstServiceProviderCapabilities = new Capabilities(CapabilitiesStatus.KNOWN, Stream.of(a, b).collect(Collectors.toSet()));
        ...
        Capabilities secondServiceProviderCapabilities = new Capabilities(CapabilitiesStatus.KNOWN, Stream.of(b, c).collect(Collectors.toSet()));
    ...
    void calculateLastUpdatedCapabiltiesOneCap() {
        ...
        Capabilities capabilities = new Capabilities(CapabilitiesStatus.KNOWN,
    ...
    void calculateLastUpdatedCapabilitiesTwoDates() {
        ...
        Capabilities earliestCap = new Capabilities(CapabilitiesStatus.KNOWN,
                Collections.singleton(new CapabilitySplit(
                        ...
                        new Metadata())),
                earliest);
        Capabilities latestCap = new Capabilities(CapabilitiesStatus.KNOWN,
                Collections.singleton(new CapabilitySplit(
                        new DatexApplication(
                                "NO-123",
                                "no-pub-2",
    ...
    void calculateGetLastUpdatedLocalCapabilities() {
        ...
        aServiceProvider.setCapabilities(new Capabilities(CapabilitiesStatus.KNOWN, Sets.newLinkedHashSet(aCap1, aCap2), aCapDate));
        ...
        bServiceProvider.setCapabilities(new Capabilities(CapabilitiesStatus.KNOWN, Sets.newLinkedHashSet(bCap1, bCap2), bCapDate));
        ...
        cServiceProvider.setCapabilities(new Capabilities(CapabilitiesStatus.KNOWN, Sets.newLinkedHashSet(cCap1, cCap2), cCapDate));
