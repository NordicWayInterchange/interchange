...
public class Neighbour {
	...
	private NeighbourCapabilities capabilities = new NeighbourCapabilities(NeighbourCapabilities.NeighbourCapabilitiesStatus.UNKNOWN, new HashSet<>());
	...
	public boolean hasCapabilities() {
		return getCapabilities() != null && getCapabilities().getStatus() == NeighbourCapabilities.NeighbourCapabilitiesStatus.KNOWN;
	}
