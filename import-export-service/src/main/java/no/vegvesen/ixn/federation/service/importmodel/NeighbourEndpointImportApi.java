...
public class NeighbourEndpointImportApi {
    ...
    public NeighbourEndpointImportApi() {

    }

    public NeighbourEndpointImportApi(String source,
                                      String host,
                                      Integer port,
    ...
    public boolean equals(Object o) {
        ...
        NeighbourEndpointImportApi that = (NeighbourEndpointImportApi) o;
    ...
    public String toString() {
        return "NeighbourEndpointImportApi{" +
                "source='" + source + '\'' +
                ", host='" + host + '\'' +
                ", port=" + port +
