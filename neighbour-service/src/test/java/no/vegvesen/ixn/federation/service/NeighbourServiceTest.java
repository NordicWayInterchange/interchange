...
class NeighbourServiceTest {
	...
	void postDatexDataTypeCapability() {
		...
		CapabilitySplitApi ericssonDataType = new CapabilitySplitApi(new DatexApplicationApi("myPublisherId", "pub-1", "NO", "1.1", Set.of("23004"), "myPublicationType"), new MetadataApi());
	...
	void postingDatexCapabilitiesReturnsStatusCreated() {
		...
		CapabilitiesSplitApi ericsson = new CapabilitiesSplitApi();
		ericsson.setName("ericsson");
		CapabilitySplitApi ericssonDataType = new CapabilitySplitApi(new DatexApplicationApi("1", "2", "NO", "3", Collections.singleton("23004"), "4"), new MetadataApi());
		ericsson.setCapabilities(Collections.singleton(ericssonDataType));
	...
	public void postingCapabilitiesUnknownInDNSReturnsError() {
		...
		unknownNeighbour.setCapabilities(Collections.singleton(new CapabilitySplitApi(new DatexApplicationApi("1", "2", "NO", "3", Collections.singleton("23004"), "4"), new MetadataApi())));
